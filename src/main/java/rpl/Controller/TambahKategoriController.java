...
//        System.out.println(ComboPilih.getValue());
        ...
        String sql="insert into Kategori(NamaKategori,Jenis) values('"+Kategoritxt.getText().toString()+"','"+pilihan+"')";
        ...
        try{
            ...
            System.out.println("sampe sini");
                ...
                stage.close();
                 ...
                 rs=st.executeQuery("Select * from user where username='"+this.usernametxt.getText()+"'");
